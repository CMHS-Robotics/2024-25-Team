...
public class RobotContainer {
    ...
    private final ParallelCommandGroup lockGroup = new ParallelCommandGroup(null);
    private final SequentialCommandGroup indexerCmd = new SequentialCommandGroup(null);
    private final SequentialCommandGroup indexerStopCommand = new SequentialCommandGroup(null);
